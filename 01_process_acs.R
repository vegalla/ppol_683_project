...
dc_income <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0(
        'data/raw/acs/dc/income/ACSST5Y',
         as.character(x),
        '.S1901_data_with_overlays_2021-12-01T145310.csv')
...
dc_house_value <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0(
        'data/raw/acs/dc/house_value/ACSST5Y', 
         as.character(x),
...
dc_social <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0(
        'data/raw/acs/dc/social/ACSDP5Y', 
         as.character(x),
...
va_income <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0(
        'data/raw/acs/norfolk/income/ACSST5Y',
         as.character(x),
        '.S1901_data_with_overlays_2021-12-13T014512.csv')
...
va_house_value <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0(
        'data/raw/acs/norfolk/house_value/ACSST5Y', 
        as.character(x),
        '.S2506_data_with_overlays_2021-12-12T185434.csv')
...
va_social <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0(
        'data/raw/acs/norfolk/social/ACSDP5Y', 
        as.character(x),
        '.DP02_data_with_overlays_2021-12-12T185039.csv')
...
if (export == TRUE) {
  ...
  va_features %>%
    write_csv('data/processed/va_features.csv')
}
