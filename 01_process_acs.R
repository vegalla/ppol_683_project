...
dc_income <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0('project/_data/raw/income/ACSST5Y',as.character(x),'.S1901_data_with_overlays_2021-12-01T145310.csv')
...
dc_house_value <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0('project/_data/raw/house_value/ACSST5Y', 
                    as.character(x),
...
dc_social <-
  purrr::map(
    ...
    function(x){
      ...
      path = paste0('project/_data/raw/social/ACSDP5Y', 
                    as.character(x),
      ...
      dc_social_processed <-
        ...
        select(geo_id, dp02_0007pe, dp02_0009pe, dp02_0039e, dp02_0064pe, dp02_0088pe, dp02_0111pe) %>%
...
if (export = TRUE) {
  dc_features %>%
    write_csv('project/_data/processed/dc_features.csv')
}
